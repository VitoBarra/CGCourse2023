...
int lez4(void)
{
	...
	Shader basic_shader;
    basic_shader.create_program("../src/shaders/3DProjectionAndTransformation.vert", "../src/shaders/ColorHack.frag");
	...
	/* define a transformation that will be applyed the body of the car */
...
//	cube_to_spoiler = rotcar*a1*a2*a3*a4;
	cube_to_spoiler = rotcar*a1*a3*a4;
